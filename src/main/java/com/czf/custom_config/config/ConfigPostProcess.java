...
//       获取@annotation注解中的prefix和file参数
     ...
     * @return
     */
    private Map<String,String> getPropertiesFromResource(String fileName) {
        Properties properties = new Properties();
        try {
            InputStream resourceAsStream = ConfigPostProcess.class.getClassLoader().getResourceAsStream(fileName);
     ...
     * @return
     */
    private  Map<String,String> getYamlFromResource(String fileName) {
        Map<String,String> map = null;
        try {
            InputStream resourceAsStream = ConfigPostProcess.class.getClassLoader().getResourceAsStream(fileName);
     ...
     * @return
     */
    private Map<String, String> configDataCleanProperties(Map<String, String> map, String prefix) {
     ...
     * @return
     */
    private Map<String, String> configDataCleanYaml(Map<String, String> map, String prefix) {
        Map<String, Object> convertMap = MapUtil.get(map, prefix, Map.class,MapUtil.newHashMap());
        Map<String, String> resultMap = new HashMap<>();
...
//    private Map<String, String> configDataCleanYaml2(Map<String, String> map, String prefix) {
//        String[] split = prefix.split(".");//多层级
//        Map<String, Object> convertMap;
//        for (String pre : split) {
//           convertMap = MapUtil.get(map, pre, Map.class,MapUtil.newHashMap());
//        }
//
//        return resultMap;
//    }
